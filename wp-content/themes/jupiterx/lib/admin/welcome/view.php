	...
	<div class="jupiterx-welcome">
		...
		<div class="jupiterx-welcome-rplugins">
			...
			<div class="jupiterx-welcome-rplugins-error">
				<div role="alert"><?php esc_html_e( 'Could not connect to Artbees server, please try again and if the issue persists contact support' ); ?></div>
			</div>
		...
		<div class="jupiterx-welcome-video" style="display: none;">
			<div class="jupiterx-welcome-video-title">
				<?php esc_html_e( 'Watch this quick walk-through video to get started:', 'jupiterx' ); ?>
			</div>
			<div class="jupiterx-welcome-video-watch">
				<iframe
					title="Watch Video"
					src="http://www.youtube.com/embed/00000000000?rel=0"
					frameBorder="0"
